...
impl Pseudocube {
   pub fn new() -> Self {
      Pseudocube {
         squares: vec![],
         ratio: 1.0,
         cursor: Cursor::Plain((0.0, 0.0), [1.0, 1.0, 1.0]),
      }
   }
   ...
   while running {
      ...
      events_loop.poll_events(|glutin::Event::WindowEvent{window_id: _, event}| {
         ...
         match event {
            ...
            MouseInput(glutin::ElementState::Pressed, glutin::MouseButton::Left) =>
               cube.start_growing(),
            MouseInput(glutin::ElementState::Released, glutin::MouseButton::Left) =>
               cube.stop_growing(),
            _ => (),
         }
